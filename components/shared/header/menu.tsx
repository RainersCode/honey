        ...
        <Sheet>
          ...
          <SheetContent className='bg-[#FFFBF8]/95 backdrop-blur-md border-l border-[#FFE4D2] flex flex-col'>
            ...
            <SheetHeader className="border-b border-[#FFE4D2] pb-4">
              <SheetTitle className='text-[#1D1D1F] font-serif text-2xl'>{APP_NAME}</SheetTitle>
            </SheetHeader>
            ...
            <SheetFooter className="mt-auto border-t border-[#FFE4D2] pt-6">
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h3 className="text-sm font-medium text-[#1D1D1F]">Contact Us</h3>
                  <div className="space-y-2">
                    <a href="tel:+1234567890" className="flex items-center gap-2 text-sm text-[#1D1D1F] hover:text-[#FF7A3D] transition-colors">
                      <Phone className="h-4 w-4" />
                      <span>+1 (234) 567-890</span>
                    </a>
                    <a href="mailto:info@honeyshop.com" className="flex items-center gap-2 text-sm text-[#1D1D1F] hover:text-[#FF7A3D] transition-colors">
                ...
                {/* Social Links */}
                <div className="space-y-3">
                  <h3 className="text-sm font-medium text-[#1D1D1F]">Follow Us</h3>
