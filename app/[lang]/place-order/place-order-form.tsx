    ...
    <div className='space-y-6'>
      ...
      <Card className='bg-white/90 backdrop-blur-[2px] shadow-md border-[#FFE4D2]'>
        <CardHeader className='border-b border-[#FFE4D2]/50'>
          <CardTitle className='text-[#1D1D1F] font-serif text-lg'>
            {dict.placeOrder.shipping.title}
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className='pt-6'>
          <div className='space-y-4'>
            {cart.items.map((item) => (
              <div
                key={item.productId}
                className='flex items-center gap-4 p-3 rounded-lg bg-[#FFFBF8] border border-[#FFE4D2]/30'
              >
        ...
        <CardContent className='pt-6'>
          <div className='space-y-3'>
            ...
            <div className='flex justify-between items-center border-t border-[#FFE4D2] pt-3 mt-3'>
              <p className='font-semibold text-lg text-[#1D1D1F]'>
                {dict.placeOrder.summary.total}
              </p>
      ...
      <Button
        onClick={onSubmit}
        className='w-full bg-[#FF7A3D] text-white hover:bg-[#ff6a2a] transition-all duration-300 px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-medium shadow-lg hover:shadow-xl'
        disabled={isPending}
      >
        {isPending ? (
