const Rating = ({ value, caption }: { value: number; caption?: string }) => {
  const Full = () => (
    <svg
      ...
      className='text-[#FF7A3D] w-4 h-auto fill-current'
      viewBox='0 0 16 16'
    >
  ...
  const Empty = () => (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      className='text-[#FF7A3D]/30 w-4 h-auto fill-current'
      viewBox='0 0 16 16'
    >
  ...
  return (
    <div className='flex gap-2'>
      ...
      {caption && <span className='text-sm text-[#1D1D1F]/70'>{caption}</span>}
    </div>
  );
};
