                    ...
                    <CarouselItem key={index}>
                      <div className="bg-white rounded-2xl p-10 shadow-[0_4px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-all duration-300 mx-auto max-w-2xl border border-gray-100">
                        ...
                        <blockquote className="relative">
                          <span className="absolute -top-4 -left-2 text-6xl text-[#FF7A3D]/10">&ldquo;</span>
                          <p className="text-gray-700 text-xl leading-relaxed text-center mb-8 relative z-10">
                            {testimonial.quote}
                          </p>
                          <span className="absolute -bottom-8 -right-2 text-6xl text-[#FF7A3D]/10">&rdquo;</span>
                        </blockquote>
                        <div className="text-center mt-12">
                          ...
                          <h3 className="font-medium text-[#1D1D1F] text-lg">{testimonial.name}</h3>
